...
>
  <head>
    ...
    <title>Inicio de Sesión | Remuneraciones</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Remuneraciones</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Bienvenid@ al Sistema del Equipo de Remuneraciones! 👋</h4>
              <p class="mb-4">Por favor, inicia sesión para acceder al contenido.</p>
