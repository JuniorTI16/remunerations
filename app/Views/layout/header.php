...
<head>
    ...
    <title><?=$title?> | Remuneraciones</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text2 demo menu-text fw-bolder">Remuneraciones</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="<?=base_url() . '/documents'?>" class="menu-link">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?=base_url()?>/public/photos/<?=$photo?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block" id="userName"><?=$name?></span>
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        ...
                        <span class="align-middle">GIF</span>
                      </a>
                    </li>
                    <li>
                      <div class="dropdown-divider"></div>
